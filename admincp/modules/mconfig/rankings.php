				...
				<label>
					<select class="form-control" name="setting_21">
						...
						<option value="2" <?php if($moduleConfig->guild_score_formula == 2) {
							echo 'selected';
						} ?>>DarkWeb Custom 1: (STR+AGI+VIT+ENE+CMD) * MULTIPLIER</option>
						<option value="3" <?php if($moduleConfig->guild_score_formula == 3) {
							echo 'selected';
						} ?>>DarkWeb Custom 2: (STR+AGI+VIT+ENE) * MULTIPLIER</option>
					</select>
				</label>
			</td>
		</tr>
