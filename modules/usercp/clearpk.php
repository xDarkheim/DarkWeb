...
try {
	...
	echo '<div class="ucp-card">';
		echo '<div class="ucp-card-header"><i class="bi bi-shield-x"></i>'.lang('module_titles_txt_13',true).'</div>';
				...
				foreach($AccountCharacters as $thisCharacter) {
					...
					echo '<form action="" method="post">';
						...
						echo '<tr>';
							...
							echo '<td><button name="submit" value="submit" class="btn btn-primary btn-sm">'.lang('clearpk_txt_4',true).'</button></td>';
						echo '</tr>';
					echo '</form>';
				}
				echo '</tbody>';
	...
	if(mconfig('zen_cost') > 0) {
		echo '<div class="module-requirements text-center">';
			echo '<p>'.langf('clearpk_txt_5', array(number_format(mconfig('zen_cost')))).'</p>';
		echo '</div>';
	}
