...
<form action="<?php echo htmlspecialchars((string) ($selectedConfigFormAction ?? ""), ENT_QUOTES, "UTF-8"); ?>" method="post">
	...
	<table class="table table-striped table-bordered table-hover module_config_tables">
		<tr>
			...
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_1', $cfg['active'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Hide Idle<br/><span>If enabled, the idle stages of castle siege will not be displayed.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_2', $cfg['hide_idle'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_3', $cfg['live_data'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Castle Owner<br/><span>Displays the castle owner.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_4', $cfg['show_castle_owner'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Castle Owner Alliance<br/><span>Displays the castle owner alliance guilds.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_5', $cfg['show_castle_owner_alliance'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Battle Countdown<br/><span>Displays the castle siege battle countdown.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_6', $cfg['show_battle_countdown'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Castle Information<br/><span>Displays the castle information.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_7', $cfg['show_castle_information'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Current Stage<br/><span>Displays the current castle siege stage.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_8', $cfg['show_current_stage'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Next Stage<br/><span>Displays the next castle siege stage.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_9', $cfg['show_next_stage'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_10', $cfg['show_battle_duration'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Registered Guilds<br/><span>Displays the registered guilds and alliances.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_11', $cfg['show_registered_guilds'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
			<th>Show Schedule<br/><span>Displays the full castle siege schedule.</span></th>
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_12', $cfg['show_schedule'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<?php \Darkheim\Application\View\FormFieldRenderer::enabledisableCheckboxes('setting_14', $cfg['show_widget'], 'Enabled', 'Disabled'); ?>
			</td>
		</tr>
	</table>
