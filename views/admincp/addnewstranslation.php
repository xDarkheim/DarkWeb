<?php
/**
 * AdminCP add news translation view.
 *
 * Variables:
 * - string   $newsId
 * - string   $defaultTitle
 * - string   $defaultContent
 * - string[] $languages         – available (non-default) languages
 * - string   $selectedLanguage
 * - string   $formTitle
 * - string   $formContent
 */
?>
<h1 class="page-header">Add News Translation</h1>
...
<form role="form" method="post">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="news_language" id="input_1">
            <option value="">Select a language ...</option>
            <?php foreach ($languages as $lang): ?>
            <option value="<?php echo htmlspecialchars($lang, ENT_QUOTES, 'UTF-8'); ?>"
                <?php echo $selectedLanguage === $lang ? 'selected' : ''; ?>>
    ...
    <button type="submit" class="btn btn-large btn-block btn-success" name="news_submit" value="ok">Add News Translation</button>
</form>
