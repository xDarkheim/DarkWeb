...
<div class="ucp-card" style="margin-bottom:16px;">
    <div class="ucp-card-header">
        ...
        <span style="margin-left:auto;font-size:11px;color:var(--ucp-text-muted);"><?php echo langf('addstats_txt_2', [$character['availablePoints']]); ?></span>
    </div>
            ...
            <div class="ucp-addstats-form">
                <form class="ucp-form ucp-stats-grid" action="" method="post">
                    ...
                    <div class="ucp-form-group">
                        <label for="addstats_str_<?php echo $index; ?>"><?php echo lang('addstats_txt_3', true); ?> <span class="ucp-stat-current">(<?php echo $character['strength']; ?>)</span></label>
                    ...
                    <div class="ucp-form-group">
                        <label for="addstats_agi_<?php echo $index; ?>"><?php echo lang('addstats_txt_4', true); ?> <span class="ucp-stat-current">(<?php echo $character['agility']; ?>)</span></label>
                    ...
                    <div class="ucp-form-group">
                        <label for="addstats_vit_<?php echo $index; ?>"><?php echo lang('addstats_txt_5', true); ?> <span class="ucp-stat-current">(<?php echo $character['vitality']; ?>)</span></label>
                    ...
                    <div class="ucp-form-group">
                        <label for="addstats_ene_<?php echo $index; ?>"><?php echo lang('addstats_txt_6', true); ?> <span class="ucp-stat-current">(<?php echo $character['energy']; ?>)</span></label>
                    ...
                    <div class="ucp-form-group">
                        <label for="addstats_cmd_<?php echo $index; ?>"><?php echo lang('addstats_txt_7', true); ?> <span class="ucp-stat-current">(<?php echo $character['command']; ?>)</span></label>
                    ...
                    <div class="ucp-form-submit" style="grid-column:1/-1;">
                        <button name="submit" value="submit" class="btn btn-primary"><?php echo lang('addstats_txt_8', true); ?></button>
                    </div>
                </form>
            </div>
        </div>
