<div class="page-title"><span><?php echo lang('module_titles_txt_2', true); ?></span></div>
    ...
    <div class="auth-card">
        ...
        <form action="" method="post" class="auth-form">
            ...
            <div class="auth-field">
                ...
                <span class="auth-hint"><a href="<?php echo $forgotPassUrl; ?>"><?php echo lang('login_txt_4', true); ?></a></span>
            </div>

            <button type="submit" name="darkheimLogin_submit" value="submit" class="auth-btn"><?php echo lang('login_txt_3', true); ?></button>
        </form>

        <div class="auth-footer">Don't have an account? <a href="<?php echo $registerUrl; ?>"><?php echo lang('menu_txt_3', true); ?></a></div>
    </div>
</div>
