...
?>
<h3 class="inst-title"><i class="bi bi-rocket-takeoff me-2"></i>Welcome to DarkWeb</h3>

<div class="inst-card mb-3">
    <div class="inst-card-header"><i class="bi bi-info-circle me-1"></i>Getting Started</div>
    <div class="inst-card-body">
        <p>This wizard will configure your <strong>DarkWeb</strong> installation step by step. Make sure your web server meets all requirements before proceeding.</p>
    ...
    <div class="col-md-6">
        <div class="inst-card h-100">
            ...
            <div class="inst-card-body" style="font-size:13px;line-height:1.8;">
                <p>DarkWeb uses a <strong>single MSSQL database</strong>:</p>
